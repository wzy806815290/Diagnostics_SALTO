...
% file route
indir_q = './Out/dist_qout_1979_2002_KGE_Balanced_Ralf/';
outdir_sd = './Out/dist_SD_1979_2002_KGE_Balanced_Ralf_TOP5/';
outdir_ts = './Out/dist_ts_split_1979_2002_KGE_Balanced_Ralf_TOP5/';
...
%for i = 1:height(CATtbl)
    ...
    % read input
    if ~isfile(infile_Q) || ~isfile(infile_Ev) || ME_MAX < minME_MAX
        continue
    end
...
%load("15993001_output9.mat")        
%f_PlotInput([], obs(5200:5400), [], [], sim(5200:5400), [], [], [])       
%f_PlotConnectedSeries(obs, segs_obs_opt_all, sim, segs_sim_opt_all, connectors)     
